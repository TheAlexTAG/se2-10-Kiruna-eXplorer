      ...
      <div>
        <div className="home-details d-grid align-items-center justify-contents-center text-center">
          <div className="main-body">
            ...
            In the heart of Sweden's Arctic wilderness, Kiruna is making history
            by moving an entire city. Perched atop Europe's largest iron ore
            mine, the ground beneath it is cracking. But instead of abandoning
            their home, 20,000 residents are taking a bold step—relocating their
            city, buildings and all, in a one-of-a-kind urban migration.
          </div>
        </div>
